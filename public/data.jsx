...
window.SEED = {
  ...
  kpis: [
    { id: 'm1', label: 'Activation', source: 'snowflake', sql: 'SELECT activation_rate AS value, activation_prior AS prev FROM analytics.kpis.activation', format: '%', value: '31.4%', target: '+15% by EOQ', trend: { dir: 'up',   pct: 2.1, period: 'vs last week' } },
    ...
    { id: 'm4', label: 'NPS', source: 'snowflake', sql: 'SELECT nps_score AS value, nps_prior AS prev FROM analytics.kpis.nps', format: 'plain', value: '57', target: 'target 60+', trend: { dir: 'flat', pct: 0, period: 'no change' } },
  ],
